...
public class LanguagesController {
    ...
    @Operation(summary="Update Languages", description="Update an already existing language", tags={"languages"})
    ...
    @Operation(summary = "Get Languages", description = "Get all the languages registered in the database", tags = {"languages"})
    ...
    @Operation(summary = "Post Languages", description = "Create a new languages", tags = {"languages"})
    ...
    @Operation(summary = "Get Languages by Id", description = "Get an specific language given an Id", tags = {"languages"})
    ...
    @Operation(summary = "Delete Language", description = "Delete an already existing language", tags = {"languages"})
